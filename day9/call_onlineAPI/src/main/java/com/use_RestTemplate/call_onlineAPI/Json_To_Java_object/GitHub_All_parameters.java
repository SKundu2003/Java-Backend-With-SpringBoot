//we uses json to java converter from google to generate java code from json


package com.use_RestTemplate.call_onlineAPI.Json_To_Java_object;

public class GitHub_All_parameters {
